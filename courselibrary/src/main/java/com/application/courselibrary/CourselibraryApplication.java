...
public class CourselibraryApplication {
    ...
    @Bean
    //will be executed when the app is opened for the first time
    //create dummy data for the management system
    //like seeding
    public CommandLineRunner initialCreate(BookService bookService) {
        return (args) -> {
            ...
            //created the book1 using the bookService class (book1 will follow the pattern of the bookService class)
